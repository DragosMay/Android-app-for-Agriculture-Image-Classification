...
import com.example.licenta.ml.Leafvcnn;
...
public class leafvcnn extends AppCompatActivity { // Renamed class for clarity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.leaf_disease_vcnn);  // Correct layout file
        ...
        predict.setOnClickListener(v -> {
            if (img != null) {
                ...
                ProgressDialog progressDialog = new ProgressDialog(leafvcnn.this);
                ...
                new Thread(() -> {
                    try {
                        ...
                        Leafvcnn model = Leafvcnn.newInstance(leafvcnn.this);
                        ...
                        Leafvcnn.Outputs outputs = model.process(inputFeature0);
