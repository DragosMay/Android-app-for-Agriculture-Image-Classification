...
import com.example.licenta.ml.FruitsVcnn;
...
public class fruits_classification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fruits);  // Ensure this layout file exists
        ...
        predict.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (img != null) {
                    ProgressDialog progressDialog = new ProgressDialog(fruits_classification.this);
                    ...
                    new Thread(() -> {
                        try {
                            FruitsVcnn model = FruitsVcnn.newInstance(fruits_classification.this);
                            ...
                            FruitsVcnn.Outputs outputs = model.process(inputFeature0);
