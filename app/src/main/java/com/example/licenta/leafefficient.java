...
import com.example.licenta.ml.Effffff;
...
public class leafefficient extends AppCompatActivity { // Renamed class for clarity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.leaf_disease_efficientnet);  // Correct layout file
        ...
        predict.setOnClickListener(v -> {
            if (img != null) {
                ...
                ProgressDialog progressDialog = new ProgressDialog(leafefficient.this);
                progressDialog.setMessage("Processing...");
                progressDialog.setCancelable(false);
                progressDialog.show();

                img = Bitmap.createScaledBitmap(img, 100, 100, true); // Resizing to match model input

                new Thread(() -> {
                    try {

                        Effffff model = Effffff.newInstance(leafefficient.this);
                        ...
                        Effffff.Outputs outputs = model.process(inputFeature0);
    ...
    protected void onActivityResult(int requestcode, int resultCode, @Nullable Intent data) {
        ...
        if (requestcode == 100 && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                imgview.setImageBitmap(MediaStore.Images.Media.getBitmap(getContentResolver(), uri));
