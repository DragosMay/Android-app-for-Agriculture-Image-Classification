...
import com.example.licenta.ml.Mobmob;
...
public class fruits_MobileNet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.fruits_mobilenet);
        ...
        predict.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (img != null) {
                    ProgressDialog progressDialog = new ProgressDialog(fruits_MobileNet.this);
                    ...
                    new Thread(() -> {
                        try {
                            Mobmob model = Mobmob.newInstance(fruits_MobileNet.this);
                            ...
                            Mobmob.Outputs outputs = model.process(inputFeature0);
